...
struct Light final
{
    ...
    Light& operator= (Light&& move)         = default;
...
class MyView::UniformData final
{
    public:
        ...
        UniformData()                                       = default;
        UniformData (UniformData&& move)                    = default;
        UniformData (const UniformData& copy)               = default;
        UniformData& operator= (UniformData&& move)         = default;
        ...
        /// <summary> Converts the desired scene::DirectionalLight into a shader-ready format. </summary>
        void setLight (const int index, const scene::DirectionalLight& sceneLight);
        
        /// <summary> Converts the desired scene::PointLight into a shader-ready format. </summary>
        void setLight (const int index, const scene::PointLight& sceneLight);
        
        /// <summary> Converts the desired scene::SpotLight into a shader-ready format. </summary>
        void setLight (const int index, const scene::SpotLight& sceneLight);
